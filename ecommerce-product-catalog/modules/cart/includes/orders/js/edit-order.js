...
jQuery( document ).ready(
	function () {
		...
		jQuery( "#add-digital-product" ).click(
			function () {
				...
				jQuery( "#new_manual_order_product_id option" ).each(
					function () {
		...
		jQuery( "#add-custom-digital-product" ).click(
			function () {
				var count = parseInt( jQuery( ".manual_products_count" ).val(), 10 ) + 1;
				jQuery( ".manual_products_count" ).val( count );
		...
		jQuery( "#order_product_list" ).on(
			'change',
			'.digital_products_dropdown',
			function () {
				var product_id   = jQuery( this ).val();
...
function disable_product_choose() {
	...
	jQuery( ".digital_products_dropdown" ).each(
		function () {
