...
if ( ! function_exists( 'ic_is_variations_price_effect_active' ) ) {
	require_once __DIR__ . '/variations-conditionals.php';
}
if ( ! function_exists( 'product_variations_menu' ) ) {
	require_once __DIR__ . '/product-variations-settings.php';
}
if ( ! function_exists( 'add_variation_metaboxes' ) && ! class_exists( 'ic_cart_variations_meta' ) ) {
	require_once __DIR__ . '/functions.php';
	require_once __DIR__ . '/variations-meta.php';
	require_once __DIR__ . '/variations-selectors.php';
	require_once __DIR__ . '/variations-front.php';
	require_once __DIR__ . '/variations-ajax.php';
	require_once __DIR__ . '/product-variations.php';
	require_once __DIR__ . '/variations-details.php';
}
...
if ( ! function_exists( 'ic_variations_register_admin_styles' ) ) {
	...
	function ic_variations_register_admin_styles() {
		wp_register_style( 'ic_variations_admin', plugins_url( '/', __FILE__ ) . 'css/variations-admin.css' . ic_filemtime( __DIR__ . '/css/variations-admin.css' ) );
		wp_register_script( 'ic_variations_admin', plugins_url( '/', __FILE__ ) . 'js/variations-admin.js' . ic_filemtime( __DIR__ . '/js/variations-admin.js' ), array( 'ic_chosen' ) );
	}
	...
	function ic_variations_register_styles() {
		...
		wp_register_script( 'ic_variations', plugins_url( '/', __FILE__ ) . 'js/variations.js' . ic_filemtime( __DIR__ . '/js/variations.js' ) );
	}
...
require_once __DIR__ . '/ext/index.php';
