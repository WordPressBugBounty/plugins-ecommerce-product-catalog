...
class IC_Catalog_Theme_Integration {
	...
	margin-left: -23px;}</style>';
				...
				$box_content .= '<p>' . sprintf( __( 'If you are a developer or would like to have full control on the product pages templates, make sure to see the %1$stemplates docs%2$s.', 'ecommerce-product-catalog' ), '<a href="https://implecode.com/docs/ecommerce-product-catalog/product-page-template/#cam=advanced-mode&key=integration-advanced-success-page-template">', '</a>' ) . '</p>';
	...
	public static function create_sample_product_with_redirect() {
		// phpcs:ignore WordPress.Security.NonceVerification.Recommended -- Existing sample-product bootstrap is driven by this query arg.
