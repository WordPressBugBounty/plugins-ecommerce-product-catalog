...
class IC_Settings_Search {
	...
	public function search_html() {
		...
		<form class="ic-settings-search<?php echo esc_attr( $class ); ?>">
			...
			<input type="submit" class="button-primary" value="<?php echo esc_attr__( 'Search', 'ecommerce-product-catalog' ); ?>">
	...
	public function search_results_settings( $search_word ) {
		if ( empty( $this->points ) ) {
			...
			<div class="ic-settings-search-empty">
				...
				printf( esc_html__( "Didn't find any adjustment options for '%s'.", 'ecommerce-product-catalog' ), esc_html( $search_word ) );
				?>
			</div>
			<?php
			return;
		...
		<h2>
			...
			printf( esc_html__( "%1\$s adjustment options found in settings for '%2\$s'", 'ecommerce-product-catalog' ), count( $this->points ), esc_html( $search_word ) );
			?>
			:
		</h2>
		<ul>
			...
			if ( count( $this->points ) > 5 ) {
				...
				<li>
					<div class="button-secondary ic-search-settings-show-button">
						...
						printf( esc_html__( 'Show %s more related adjustment options', 'ecommerce-product-catalog' ), count( $this->points ) - 5 );
						?>
					</div>
				</li>
				<?php
	...
	public function search_results_docs( $search_word ) {
		...
		<div class="ic-docs-ajax-search-container">
			<div class="ic-docs-search-placeholder"><?php esc_html_e( 'Searching also in docs...', 'ecommerce-product-catalog' ); ?></div>
		</div>
		<script>
			var data = {
	...
	public function ajax_search_docs() {
		...
		if ( ! empty( $data ) && is_array( $data ) ) {
			...
			<?php
				...
				printf( esc_html__( "%1\$s documentation pages found for '%2\$s'", 'ecommerce-product-catalog' ), count( $data ), esc_html( $search_word ) );
			?>
				:</h2>
			<ul>
				<?php
				...
				if ( count( $data ) > 5 ) {
					...
					<li>
						<div class="button-secondary ic-search-docs-show-button">
							...
							printf( esc_html__( 'Show %s more related docs', 'ecommerce-product-catalog' ), count( $data ) - 5 );
							?>
						</div>
					</li>
					<?php
			...
			<div class="ic-docs-search-empty">
				<?php
				/* translators: %s: Search phrase. */
				printf( esc_html__( "Didn't find any docs or tutorials for '%s'.", 'ecommerce-product-catalog' ), esc_html( $search_word ) );
				?>
			</div>
			<?php
