	...
	<div class="ic-select-mode-container">
		<div class="about__section is-feature has-subtle-background-color">
			<h2>
				...
				printf( esc_html__( 'Choose your preferred %s configuration.', 'ecommerce-product-catalog' ), esc_html( IC_CATALOG_PLUGIN_NAME ) );
				?>
			</h2>
			<p>
				<?php esc_html_e( 'Use the buttons below to choose the catalog mode. Simple Catalog is enabled by default.', 'ecommerce-product-catalog' ); ?>
			</p>
			<p>
				<?php esc_html_e( 'You can make additional adjustments in the settings later.', 'ecommerce-product-catalog' ); ?>
			</p>
		</div>
		...
		<div class="about__section has-2-columns">
			<div class="column">
				<h2><?php esc_html_e( 'Web Store', 'ecommerce-product-catalog' ); ?></h2>
				<p><?php esc_html_e( 'Enable this option if you are planning to sell products directly from the website.', 'ecommerce-product-catalog' ); ?></p>
				<p><?php esc_html_e( 'The shopping cart feature will be enabled in this mode.', 'ecommerce-product-catalog' ); ?></p>
				<p class="ic-select-mode-button-container">
					<a class="button-primary"
						...
						<?php esc_html_e( 'Enable Web Store Mode', 'ecommerce-product-catalog' ); ?>
					</a>
				</p>
			</div>
			<div class="column">
				<h2><?php esc_html_e( 'Inquiry Catalog', 'ecommerce-product-catalog' ); ?></h2>
				<p><?php esc_html_e( 'Enable this option if you want the customers to ask for price.', 'ecommerce-product-catalog' ); ?></p>
				<p><?php esc_html_e( 'The quote cart feature will be enabled in this mode.', 'ecommerce-product-catalog' ); ?></p>
				<p class="ic-select-mode-button-container">
					<a class="button-primary"
						...
						<?php esc_html_e( 'Enable Inquiry Catalog Mode', 'ecommerce-product-catalog' ); ?>
					</a>
				</p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns has-subtle-background-color">
			<div class="column">
				<h2><?php esc_html_e( 'Affiliate Catalog', 'ecommerce-product-catalog' ); ?></h2>
				<p><?php esc_html_e( 'Enable this option if you want the customers to click the affiliate button.', 'ecommerce-product-catalog' ); ?></p>
				<p><?php esc_html_e( 'The affiliate button feature will be enabled in this mode.', 'ecommerce-product-catalog' ); ?></p>
				<p class="ic-select-mode-button-container">
					<a class="button-primary"
						...
						<?php esc_html_e( 'Enable Affiliate Catalog Mode', 'ecommerce-product-catalog' ); ?>
					</a>
				</p>
			</div>
			<div class="column">
				<h2><?php esc_html_e( 'Simple Catalog', 'ecommerce-product-catalog' ); ?></h2>
				<p><?php esc_html_e( 'Enable this option if you want to display products without any call to action.', 'ecommerce-product-catalog' ); ?></p>
				<p class="ic-select-mode-button-container">
					<a class="button-primary"
						...
						<?php esc_html_e( 'Enable Simple Catalog Mode', 'ecommerce-product-catalog' ); ?>
					</a>
				</p>
			</div>
		</div>
...
?>
	<div class="about__section has-subtle-background-color has-2-columns">
		<header class="is-section-header">
			<h2><?php esc_html_e( 'For every day users', 'ecommerce-product-catalog' ); ?></h2>
			<p>
				<?php
				/* translators: %s: Plugin name. */
				printf( esc_html__( '%s is carefully crafted for seamless usability by everyday users.', 'ecommerce-product-catalog' ), esc_html( IC_CATALOG_PLUGIN_NAME ) );
				?>
			</p>
		</header>
		<div class="column">
			<h3><?php esc_html_e( 'Catalog Blocks', 'ecommerce-product-catalog' ); ?></h3>
			<p><?php esc_html_e( 'You can use three different blocks to display catalog parts.', 'ecommerce-product-catalog' ); ?></p>
			<p>
				<?php
				/* translators: 1: "Show Catalog" block name, 2: "Show Products" block name. */
				printf( esc_html__( 'Start with %1$s block to display your main listing page or %2$s to display only selected products.', 'ecommerce-product-catalog' ), esc_html__( 'Show Catalog', 'ecommerce-product-catalog' ), esc_html__( 'Show Products', 'ecommerce-product-catalog' ) );
				?>
			</p>
			<p>
				<a href="https://implecode.com/docs/ecommerce-product-catalog/all-product-catalog-blocks/#cam=welcome&key=blocks"><?php esc_html_e( 'Blocks usage', 'ecommerce-product-catalog' ); ?></a>
			</p>
		</div>
		<div class="column">
			<h3><?php esc_html_e( 'Customize Headings and Text', 'ecommerce-product-catalog' ); ?></h3>
			<p><?php esc_html_e( 'You have complete control over tailoring any text visible on the front-end through an intuitive settings screen.', 'ecommerce-product-catalog' ); ?></p>
			<p><?php esc_html_e( 'You can make the catalog multilingual thanks to full Polylang compatibility.', 'ecommerce-product-catalog' ); ?></p>
			<p><a target="_blank"
					href="https://implecode.com/docs/ecommerce-product-catalog/change-catalog-headings-text/#cam=welcome&key=text-customization"><?php esc_html_e( 'Headings & text customization', 'ecommerce-product-catalog' ); ?></a>
				| <a target="_blank"
					href="https://implecode.com/docs/ecommerce-product-catalog/polylang-and-ecommerce-product-catalog/#cam=welcome&key=polylang"><?php esc_html_e( 'EPC & Polylang', 'ecommerce-product-catalog' ); ?></a>
			</p>
		</div>
	</div>
	<div class="about__section has-subtle-background-color has-2-columns">
