...
?>
	...
	<div class="about__section is-feature ic-mode-selected-container">
		...
		if ( empty( $activation_choice ) ) {
			...
			echo '<h1>' . sprintf( esc_html__( '%s mode is active now!', 'ecommmerce-product-catalog' ), esc_html( ic_ucfirst( $selected_mode ) ) ) . '</h1>';
		}
		?>
		<?php
		...
		<div class="column">
			<p style="text-align: center;"><a
						href="<?php echo esc_url( admin_url( 'edit.php?post_type=al_product&page=implecode_welcome' ) ); ?>"><?php esc_html_e( 'GO BACK TO MODE SELECTION', 'ecommerce-product-catalog' ); ?></a>
			</p>
		</div>
	</div>
	...
	<div class="about__section has-2-columns">
		<header class="is-section-header">
			<h2><?php esc_html_e( 'Display Catalog', 'ecommerce-product-catalog' ); ?></h2>
			<p><?php esc_html_e( 'You can select the main catalog page in the general settings screen. It will show categories and products according to the catalog settings.', 'ecommerce-product-catalog' ); ?></p>
			<p><?php esc_html_e( 'Apart from the main catalog page, you can display products and categories anywhere on the website.', 'ecommerce-product-catalog' ); ?></p>
		</header>
		...
		<?php } ?>
		<div class="column">
			<h3><?php esc_html_e( 'Catalog Shortcodes', 'ecommerce-product-catalog' ); ?></h3>
			<p><?php esc_html_e( 'You can use many different shortcodes to displays catalog parts.', 'ecommerce-product-catalog' ); ?></p>
			<p>
				<a href="https://implecode.com/docs/ecommerce-product-catalog/product-catalog-shortcodes/#cam=welcome&key=shortcodes"><?php esc_html_e( 'Available Shortcodes', 'ecommerce-product-catalog' ); ?></a>
			</p>
		</div>
	</div>
	...
	<div class="about__section">
		<div class="column">
			...
			<p>
				 ...
				 */
				$documentation_template = esc_html__( 'There’s a lot more for developers to love in %1$s. To discover more and learn how to make the catalog shine on your sites, themes, plugins and more, check the %2$sdocumentation.%3$s', 'ecommerce-product-catalog' );
